...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<div id="fh5co-offcanvas">
		...
		<div class="fh5co-bio">
			<figure>
				<img src="assets2/images/person1.jpg" alt="Free HTML5 Bootstrap Template" class="img-responsive">
			</figure>
	...
	<div class="container-fluid">
		<div class="row fh5co-post-entry">
			<?php foreach ($posts as $key => $value) { ?>
				...
				<figure>
					<a href="views/frontend/posts/detail.php"><img src="assets2/images/pic_1.jpg" alt="Image" class="img-responsive"></a>
				</figure>
				<span class="fh5co-meta"><a href="views/frontend/posts/detail.php"><?php $code = $value['category_id'];echo $categories[$code-1]['name']; ?></a></span>
				<h2 class="fh5co-article-title"><a href="views/frontend/posts/detail.php"><?php echo $value['title'] ?></a></h2>
				<span class="fh5co-meta fh5co-date"><?php echo $value['created_at']; ?></span>
			</article>
			<?php } ?>
			<!-- <article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="single.html"><img src="assets2/images/pic_1.jpg" alt="Image" class="img-responsive"></a>
				</figure>
			...
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="single.html"><img src="assets2/images/pic_2.jpg" alt="Image" class="img-responsive"></a>
				</figure>
				<span class="fh5co-meta"><a href="single.html">Food &amp; Drink</a></span>
			...
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="single.html"><img src="assets2/images/pic_3.jpg" alt="Image" class="img-responsive"></a>
				</figure>
			...
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="single.html"><img src="assets2/images/pic_4.jpg" alt="Image" class="img-responsive"></a>
				</figure>
				<span class="fh5co-meta"><a href="single.html">Travel</a>, <a href="single.html">Style</a></span>
			...
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="single.html"><img src="assets2/images/pic_5.jpg" alt="Image" class="img-responsive"></a>
				</figure>
			...
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="single.html"><img src="assets2/images/pic_6.jpg" alt="Image" class="img-responsive"></a>
				</figure>
				<span class="fh5co-meta"><a href="single.html">Travel</a>, <a href="single.html">Style</a></span>
			...
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="single.html"><img src="assets2/images/pic_7.jpg" alt="Image" class="img-responsive"></a>
				</figure>
			...
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="single.html"><img src="assets2/images/pic_8.jpg" alt="Image" class="img-responsive"></a>
				</figure>
				<span class="fh5co-meta"><a href="single.html">Travel</a>, <a href="single.html">Style</a></span>
